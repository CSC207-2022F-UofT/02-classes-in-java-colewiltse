...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes two String objects as arguments.
     *
     * @param s1 the first half of this Silly instance's name.
     * @param s2 the second half of this Silly instance's name.
     */
